...
class ExecutionLogsApi:
    ...
    @validate_call
    def execution_logs_session_ids_retrieve(
        self,
    ...
    @validate_call
    def execution_logs_session_ids_retrieve_with_http_info(
        self,
        starts_with: Annotated[
            Optional[StrictStr], Field(description="Filter session_ids that start with this prefix")
        ] = None,
    ...
    @validate_call
    def execution_logs_session_ids_retrieve_without_preload_content(
        self,
        starts_with: Annotated[
            Optional[StrictStr], Field(description="Filter session_ids that start with this prefix")
        ] = None,
    ...
    @validate_call
    def execution_logs_set_tags_create(
        self,
    ...
    @validate_call
    def execution_logs_set_tags_create_with_http_info(
        self,
        batch_set_tags_model_request: BatchSetTagsModelRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def execution_logs_set_tags_create_without_preload_content(
        self,
        batch_set_tags_model_request: BatchSetTagsModelRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def execution_logs_user_ids_retrieve(
        self,
        starts_with: Annotated[
    ...
    @validate_call
    def execution_logs_user_ids_retrieve_with_http_info(
        self,
        starts_with: Annotated[
            Optional[StrictStr], Field(description="Filter user_ids that start with this prefix")
        ] = None,
    ...
    @validate_call
    def execution_logs_user_ids_retrieve_without_preload_content(
        self,
        starts_with: Annotated[
            Optional[StrictStr], Field(description="Filter user_ids that start with this prefix")
        ] = None,
