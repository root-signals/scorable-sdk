...
class MessagesLog(BaseModel):
    ...
    turns: List[MessageLogTurn]
    target: StrictStr
    __properties: ClassVar[List[str]] = ["turns", "target"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesLog from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesLog from a dict"""
        if obj is None:
            return None
