...
class TurnInputRequest(BaseModel):
    ...
    tool_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["index", "role", "content", "contexts", "tool_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TurnInputRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TurnInputRequest from a dict"""
        if obj is None:
            return None
