...
class EvaluatorsApi:
    ...
    @validate_call
    async def evaluators_calibrate_create(
        self,
    ...
    @validate_call
    async def evaluators_calibrate_create_with_http_info(
        self,
        skill_test_input_request: SkillTestInputRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def evaluators_calibrate_create_without_preload_content(
        self,
        skill_test_input_request: SkillTestInputRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def evaluators_calibrate_create2(
        self,
        id: StrictStr,
    ...
    @validate_call
    async def evaluators_calibrate_create2_with_http_info(
        self,
        id: StrictStr,
        skill_test_data_request: Optional[SkillTestDataRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_calibrate_create2_without_preload_content(
        self,
        id: StrictStr,
        skill_test_data_request: Optional[SkillTestDataRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_create_with_http_info(
        self,
        evaluator_request: EvaluatorRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def evaluators_create_without_preload_content(
        self,
        evaluator_request: EvaluatorRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def evaluators_destroy_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def evaluators_destroy_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    async def evaluators_duplicate_create(
        self,
        id: StrictStr,
        duplicate_request: Optional[DuplicateRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param id: (required)
        :type id: str
        :param duplicate_request:
        :type duplicate_request: DuplicateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _evaluators_duplicate_create_serialize(
        ...
        if duplicate_request is not None:
            _body_params = duplicate_request
    ...
    @validate_call
    async def evaluators_execute_by_name_create(
        self,
    ...
    @validate_call
    async def evaluators_execute_by_name_create_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="The name of the evaluator to execute")],
        evaluator_execution_request: Optional[EvaluatorExecutionRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_execute_by_name_create_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="The name of the evaluator to execute")],
        evaluator_execution_request: Optional[EvaluatorExecutionRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_execute_create(
        self,
    ...
    @validate_call
    async def evaluators_execute_create_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        evaluator_execution_request: Optional[EvaluatorExecutionRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_execute_create_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        evaluator_execution_request: Optional[EvaluatorExecutionRequest] = None,
        _request_timeout: Union[
    ...
    async def evaluators_list(
        ...
        project_id: Annotated[
            Optional[StrictStr],
            Field(description="Filter by project. Public evaluators are excluded when this filter is set."),
        ] = None,
        search: Annotated[
        ...
        :type page_size: int
        :param project_id: Filter by project. Public evaluators are excluded when this filter is set.
        :type project_id: str
    ...
    @validate_call
    async def evaluators_partial_update(
        self,
        id: StrictStr,
    ...
    @validate_call
    async def evaluators_partial_update_with_http_info(
        self,
        id: StrictStr,
        patched_evaluator_request: Optional[PatchedEvaluatorRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_partial_update_without_preload_content(
        self,
        id: StrictStr,
        patched_evaluator_request: Optional[PatchedEvaluatorRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_retrieve_with_http_info(
        self,
        id: StrictStr,
        version_id: Annotated[Optional[StrictStr], Field(description="Get a specific version of the evaluator")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_retrieve_without_preload_content(
        self,
        id: StrictStr,
        version_id: Annotated[Optional[StrictStr], Field(description="Get a specific version of the evaluator")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_update_with_http_info(
        self,
        id: StrictStr,
        evaluator_request: EvaluatorRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_update_without_preload_content(
        self,
        id: StrictStr,
        evaluator_request: EvaluatorRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def evaluators_versions_list_with_http_info(
        self,
        id: StrictStr,
        cursor: Annotated[Optional[StrictStr], Field(description="The pagination cursor value.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
    ...
    @validate_call
    async def evaluators_versions_list_without_preload_content(
        self,
        id: StrictStr,
        cursor: Annotated[Optional[StrictStr], Field(description="The pagination cursor value.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
