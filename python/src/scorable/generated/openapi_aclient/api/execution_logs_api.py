...
class ExecutionLogsApi:
    ...
    async def execution_logs_list(
        ...
        project_id: Annotated[Optional[StrictStr], Field(description="Filter logs by project UUID")] = None,
        ...
        :type page_size: int
        :param project_id: Filter logs by project UUID
        :type project_id: str
    ...
    @validate_call
    async def execution_logs_set_tags_create(
        self,
        batch_set_tags_model_request: BatchSetTagsModelRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        Set tags on multiple execution logs, replacing any existing tags.

        :param batch_set_tags_model_request: (required)
        :type batch_set_tags_model_request: BatchSetTagsModelRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._execution_logs_set_tags_create_serialize(
            batch_set_tags_model_request=batch_set_tags_model_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    async def execution_logs_set_tags_create_with_http_info(
        self,
        batch_set_tags_model_request: BatchSetTagsModelRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def execution_logs_set_tags_create_without_preload_content(
        self,
        batch_set_tags_model_request: BatchSetTagsModelRequest,
        _request_timeout: Union[
            None,
    ...
    def _execution_logs_set_tags_create_serialize(
        self,
        batch_set_tags_model_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if batch_set_tags_model_request is not None:
            _body_params = batch_set_tags_model_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/execution-logs/set-tags/",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
